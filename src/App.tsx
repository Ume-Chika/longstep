...
const helpTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: '道筋はどう繋ぐのが正しい？',
        body: <>どちらかでも進められる作業は<strong>「分岐」</strong>させ、両方が終わってからでないとできない目標へは<strong>「合流」</strong>させます。カード右端の✏️をドラッグすることで自由に道筋を繋げられます。</>,
      },
      {
      ...
      },
      {
        ...
        body: <>できます。ホーム画面で計画を右クリック→<strong>「AI連携ファイルを追加」</strong>→作業したい各プロジェクトフォルダを選択で、AI連携ファイルを追加できます。複数のフォルダからAIエージェントがあなたの計画書を編集できるようになります。</>,
      },
      {
